    ...
    <div class="w-full md:w-2/12">
        ...
        <div class="xl:w-10/12 h-screen flex flex-col justify-center items-center p-2">
            <div class=" bg-gradient-to-br border border-gray-700 bg-gray-200 p-8 rounded shadow-md shadow-gray-600 w-2/3 ">
                ...
                <h2 class="text-2xl font-semibold mb-6 text-gray-700 text-center">Edit Produk</h2>
                <form action="{{ route('update-product', $product->id) }}" method="POST">
                    @method('PUT')
                    @csrf
                    <div class="mb-4">
                        <label for="name" class="block text-gray-700">Nama </label>
                        <input type="text" placeholder="Nama" value="{{ $product->name }}" name="name" required class="form-input mt-1 block w-full border p-1 pl-2 text-black">
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <label class="block text-gray-700" for="harga">
                            <input type="number" name="harga" value="{{ $product->harga }}" id="harga" placeholder="1000000" class="form-input mt-1 block w-full border p-1 pl-2 text-black ">
                        </label>
                    </div>
